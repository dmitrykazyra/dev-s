                            ...
                            synchronized (REQUESTS_LIST) {
                                REQUESTS_LIST.add(new ReqInfo()
                                        ...
                                        .setReqAnswer(String.format("Status=%d, ReasonPhrase='%s'",
                                                response.getStatus(),
                                                response.getStatusInfo().getReasonPhrase()))
                                        .setReqDuration((int) stopWatcher.getTimeExecMillis())
...
//                                    REQ_LIST.size()));
    ...
    public void setServerReadTimeout(final String serverReadTimeout) {
    ...
    public void setServerConnectTimeout(final String serverConnectTimeout) {
