...
//    }
    ...
    final static private SpringBootMap BOOT_APPS = NullSafe.createObject(SpringBootMap.class);
    ...
    public Unit4Test() {
        ...
        if (!ServiceFuncs.<Class<? extends SpringBoot4Test>, SpringBoot4Test>getMapValue(BOOT_APPS, mapEntry -> mapEntry.getKey().equals(sbClass))
                .isPresent()) {
